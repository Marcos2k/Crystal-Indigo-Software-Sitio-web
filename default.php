...
<head>
	<title>Crystal Indigo Software</title>
       ...
       <meta name="keywords" content="Crystal Indigo, Software, Argentina, Jesus Maria, Cordoba, Córdoba, Sistemas Informaticos, Gestión, Negocios, Windows, Linux, .Net, Java, Soluciones,Empresas, Soluciones Empresariales, Internet, Pymes, Negocios, Informatica, Computacion, Hardware, Computadoras, Comunicaciones, Tecnologia, Analista, Analistas, Sistemas, Programas, Analista en Sistemas de Computacion, Internet, Jesús María, America, America Latina,Visual Basic,Visual, Basic, PHP, SQL, Bases de datos, Facturación, SEO, Social Media, Social, Multimedia" />
   ...
   <div class="container">
   	<section class="main row">
		<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
			<p class="titulos">Bienvenido</p>
			<p>Gracias por visitar este sitio web, espero que puedas resolver todas tus dudas e inquitudes</p>
			<!-- SLIDESHOW -->
   		 <div id="slider">
        	<ul class="bjqs">
               <li>
                  <img src="Imagenes/1.jpg" alt="Análisis y desarrollo de sistemas" title="Análisis y desarrollo de sistemas informaticos" />
            	</li>
           	    <li>
                  <img src="Imagenes/2.jpg" alt="Diseño y desarrollo web" title="Diseño y desarrollo web" />
            	</li>
            	<li>
                	<img src="Imagenes/3.jpg" alt="Servicio técnico de PC y Notebooks" title="Servicio técnico de PC y Notebooks" />
            	</li>
            	<li>
                	<img src="Imagenes/4.png" alt="Posicionamiento web y Marketing digital en la red, SEO" title="Posicionamiento web y Marketing digital en la red" />
            	</li>
        	</ul>
      	    </div>

	      <!-- IMPORTAMOS SCRIPT.JS -->
